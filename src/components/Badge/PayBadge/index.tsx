...
const PayBadge = ({
  ...
  ? `text-gray-20 tablet:bg-gray-20` 
  : `text-red-40 tablet:bg-red-40`;

  return (
    <div
      className={cn(
        "flex max-w-fit items-center gap-x-4 rounded-20 bg-white px-12 py-10 text-12-regular leading-none tablet:text-14-bold tablet:text-white",
        closedStatusClass,
      )}
    >
