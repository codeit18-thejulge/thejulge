  ...
  return (
    <footer className={cn("w-full", "flex justify-center", "bg-gray-20")}>
      <div
        className={cn(
          "w-full max-w-1028",
          "px-20 pt-32 pb-16 tablet:p-32",
          "grid grid-cols-2 tablet:grid-cols-3 gap-40 items-center",
        )}
      >
        <div
          className={cn(
            "text-12-regular tablet:text-16-regular text-gray-50",
        ...
        <nav aria-label="footer links" className={cn("col-span-1", "tablet:order-2")}>
          <ul
            className={cn(
              "flex justify-start tablet:justify-center gap-30",
              "text-14-regular tablet:text-16-regular text-gray-50",
            )}
          >
            <li>
