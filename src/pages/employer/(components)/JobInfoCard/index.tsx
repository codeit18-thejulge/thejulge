...
const JobInfoCard = ({ res, bgColor, ...props }: ArticleProps) => {
  ...
  return (
    <>
      ...
      <h2 className="text-20-bold tablet:text-28-bold mb-24">{item?.shop.item.name}</h2>
      {item ? (
        <article
          className={cn(
      ...
      <dl className="mt-24 rounded-12 bg-gray-10 p-30">
